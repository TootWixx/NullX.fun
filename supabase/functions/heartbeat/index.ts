...
Deno.serve(async (req) => {
  ...
  try {
    ...
    // Note: User messages are stored in message_threads but NOT marked as delivered here.
    // The is_delivered flag is only for admin->user messages.
    // User->admin messages are always visible in the admin dashboard thread view.
